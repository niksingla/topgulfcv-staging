        ...
        <div class="banner-inner">
            ...
            <?php
                ...
                while ($the_query->have_posts()):
                    ...
                    ?>
                  <div class="item">
                    <img src=" <?php the_field('background_images'); ?>" alt="banner-img" class="img-fluid">
                    <div class="slider_content">
                         <div class="banner-inner-content">
                            <div class="container c-container">
                                <div class="row align-items-center justify-content-center">
                                    <div class="col-lg-12 col-12">
                                        <div class="banner-left-sec" data-aos="fade-zoom-in" data-aos-easing="ease-in-back"
                                            data-aos-delay="80" data-aos-offset="0">
                                            <h1>
                                            <?php the_field('banner_text'); ?>
                                            </h1>
                                            <a href="<?php the_field('button_url'); ?>" class="red-btn"> <?php the_field('button_text'); ?></a>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-12 mb-2 col-lg-4" data-aos="zoom-in">
                            <div class="job-sec-box">
                                ...
                                <div class="d-flex justify-content-center readm">
                                    ...
                                    <button class="red-btn my-5 open-popup" onclick="window.location.href = '<?php the_permalink(); ?>?form_fill';">
    ...
    <section class="feedback want-hide">
        <div class="container c-container">
            ...
            <div class="testimonial-inner">
                                        ...
                                        <div class="item">
                                            <div class="client-slider-inner">
                                                <img src="<?php echo get_template_directory_uri(); ?>/images/quote-img.png"
                                                    ...
                                                    <a href="/testimonials/">  <?php the_content(); ?> </a>
                                                <div class="d-flex align-items-center justify-content-center home_feedback">
                                                    ...
                                                    <div class="ms-3">
                                                        <h6>
                                                        <a href="/testimonials/">     <?php the_title(); ?> </a>
                                                        </h6>
                                                        <h6>
                ...
                <a href="/testimonials/"class="red-btn my-2 my-sm-4">Read more</a>
                </div>
            </div>
    ...
    <section class="blog">
        <div class="container c-container">
            ...
            <div class="blog-inner">
                ...
                <div class="d-flex justify-content-center readm">
                <a href="/blog/"class="red-btn my-2 my-sm-4"><?php echo the_field('testimonials_button_text'); ?></a>
                </div>
            </div>
        </div>
    </section>
